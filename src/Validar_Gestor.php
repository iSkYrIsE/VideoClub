...
<form action="Validar_Gestor.php" method="post" name="form_datos" enctype="multipart/form-data">    
    <div>
        <p>INTRODUCIR DATOS GESTOR</p>
    ...
    <body>
        ...
        if (empty($_POST)) {
            ...
            if (!validar($pwd, $email, $error)) {
                ...
                header("location:Procesar_Datos_Validar_Gestor.php");
            }
        }
        ?>
    </body>
